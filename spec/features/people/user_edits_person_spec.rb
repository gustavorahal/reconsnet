...
feature 'Usuário edita uma pessoa' do
  ...
  scenario 'quando o gênero não é detectado automaticamente, mostrar o select para gênero', sidekiq: :inline do
    ...
    # cria uma pessoa que o sistema NÃO consegue identificar o gênero e portando
    # deveria mostra o select para gênero
